...
const SPECS: Spec[] = [
  { pos: [-11, 0, -3], w: 6, h: 8, d: 12, tex: 0, tint: "#5a5f72", roof: "ac" },
  { pos: [-17, 0, -9], w: 8, h: 15, d: 8, tex: 1, tint: "#4c515f", setback: 3, roof: "tank" },
  { pos: [-8, 0, -18], w: 7, h: 20, d: 6, tex: 2, tint: "#565b6d", roof: "antenna" },
  { pos: [0, 0, -19], w: 10, h: 13, d: 5, tex: 3, tint: "#4a4f5e", roof: "billboard", billboardColor: "#ff4fd8" },
  { pos: [9, 0, -18], w: 7, h: 24, d: 6, tex: 1, tint: "#5a5f72", setback: 4, roof: "antenna" },
  { pos: [16, 0, -3], w: 6, h: 10, d: 12, tex: 2, tint: "#4e5364", roof: "tank" },
  { pos: [22, 0, -10], w: 8, h: 17, d: 8, tex: 0, tint: "#565b6d", roof: "billboard", billboardColor: "#4fd8ff" },
  { pos: [-23, 0, -6], w: 7, h: 12, d: 10, tex: 3, tint: "#4a4f5e", roof: "ac" },
];
